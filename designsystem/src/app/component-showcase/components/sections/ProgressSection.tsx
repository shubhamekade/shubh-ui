...
export default function ProgressSection() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(
      () => setValue((v) => Math.min(v + Math.floor(Math.random() * 8) + 3, 100)),
      120
    );
...
;`}
      ...
      <ShowcaseSection
        ...
        props={[
          ...
          {
            name: 'color',
            type: "'primary' | 'success' | 'warning' | 'destructive' | 'navy'",
            default: "'primary'",
      ...
      >
        <div className="w-full max-w-sm space-y-4">
          ...
          <div className="flex gap-2">
            <Button size="sm" onClick={() => setRunning(true)} disabled={running || value === 100}>
