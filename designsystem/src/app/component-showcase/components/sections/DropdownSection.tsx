        ...
        <div className="w-full space-y-4">
          ...
          <div className="flex items-center justify-center p-8 bg-gray-50 rounded-lg border border-[#d7d7d7]">
            <Dropdown
              ...
              trigger={
                <Button rightIcon={<ChevronDown className="h-4 w-4" />} disabled={ctrl.disabled}>
                  Actions
                </Button>
              }
              items={[
...
/>`}
      >
        <Dropdown
          trigger={
            <Button rightIcon={<ChevronDown className="h-4 w-4" />}>Component actions</Button>
          }
          items={[
            {
              id: 'edit',
          ...
          <Dropdown
            ...
            trigger={
              <div className="flex items-center gap-2 cursor-pointer p-1.5 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <span className="text-sm font-medium text-[#1e1e1e] hidden sm:block">
                  Mia Kowalski
                </span>
