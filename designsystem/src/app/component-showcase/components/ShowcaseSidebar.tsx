    ...
    >
      ...
      >
        <div className="flex items-center gap-2.5">
          <div
            className={cn(
              'h-7 w-7 rounded-md text-xs font-bold flex items-center justify-center shrink-0',
              isNavy ? 'bg-white/10 text-white' : 'bg-[#000080] text-white'
            )}
          >
            DS
          </div>
          <div>
            <span
              className={cn(
                'font-semibold text-sm block leading-tight',
                isNavy ? 'text-white' : 'text-[#1e1e1e]'
              )}
            >
              DesignSystem
            </span>
            <span
              className={cn('text-xs leading-tight', isNavy ? 'text-white/40' : 'text-[#808080]')}
            >
              v1.0.0
            </span>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <span className={cn('text-xs', isNavy ? 'text-white/40' : 'text-[#808080]')}>
            Components
          </span>
        </div>
      ...
      {/* Search */}
      <div className={cn('px-3 py-3 border-b', isNavy ? 'border-white/10' : 'border-[#e0e0e0]')}>
          ...
          <input
            ...
            className={cn(
              ...
              isNavy
                ...
                : 'bg-white border border-[#d7d7d7] text-[#1e1e1e] placeholder:text-[#b0b0b0] focus:border-[#000080]'
            )}
      ...
      >
        {categories.length === 0 ? (
          <div className="px-4 py-8 text-center">
            <Package
              className={cn('h-8 w-8 mx-auto mb-2', isNavy ? 'text-white/20' : 'text-[#d7d7d7]')}
            />
      ...
      {/* Footer */}
      <div className={cn('px-4 py-3 border-t', isNavy ? 'border-white/10' : 'border-[#e0e0e0]')}>
