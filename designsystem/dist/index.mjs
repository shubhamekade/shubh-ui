...
var CardDescription = forwardRef3(
  (_a, ref) => {
    var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
    return /* @__PURE__ */ jsx3("p", __spreadValues({ ref, className: cn("text-sm leading-relaxed text-muted-foreground", className) }, props));
  }
);
            ...
            children: [
              (title || showCloseButton) && /* @__PURE__ */ jsxs3("div", { className: "flex items-start justify-between border-b border-border/50 px-6 py-4", children: [
                /* @__PURE__ */ jsxs3("div", { children: [
                  title && /* @__PURE__ */ jsx6("h2", { id: "modal-title", className: "text-lg font-semibold tracking-tight text-foreground", children: title }),
                  description && /* @__PURE__ */ jsx6("p", { id: "modal-description", className: "mt-1 text-sm leading-relaxed text-muted-foreground", children: description })
                ] }),
...
function Table({
  ...
  return /* @__PURE__ */ jsx7("div", { className: cn("w-full overflow-x-auto rounded-xl border border-border bg-surface shadow-card", className), children: /* @__PURE__ */ jsxs4("table", { className: "w-full text-sm border-collapse", children: [
...
function DatePicker({
  ...
  useClickOutside(wrapperRef, useCallback3(() => setOpen(false), []));
...
function ServerDataTable({
  ...
  return /* @__PURE__ */ jsxs22("div", { className: `w-full ${className}`, children: [
    /* @__PURE__ */ jsx26("div", { className: "mb-5 flex justify-center", children: /* @__PURE__ */ jsxs22("div", { className: `inline-flex overflow-hidden rounded-full border ${tk.toggleBorder} bg-background/70 p-1`, children: [
      /* @__PURE__ */ jsx26(
        "button",
        {
...
var SkeletonCard = ({ className }) => /* @__PURE__ */ jsxs23("div", { className: cn("space-y-3 rounded-2xl border border-border bg-card p-5 shadow-card", className), children: [
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs31("div", { className: "flex min-w-0 flex-col", children: [
            ...
            /* @__PURE__ */ jsxs31("div", { className: cn("grid flex-1 grid-cols-1 gap-2xl px-4 py-2xl sm:px-6 xl:grid-cols-[minmax(0,1fr)_20rem]", contentClassName), children: [
...
var Heading = forwardRef17((_a, ref) => {
...
var Inline = forwardRef18((_a, ref) => {
...
function ThemeEditor() {
  ...
  return /* @__PURE__ */ jsxs32(Card_default, { variant: "elevated", className: "overflow-hidden border-border/80 bg-surface-elevated/90 shadow-card-md", children: [
    /* @__PURE__ */ jsx45(CardHeader, { className: "border-b border-border/70 pb-lg", children: /* @__PURE__ */ jsxs32("div", { className: "flex items-start justify-between gap-lg", children: [
      ...
      /* @__PURE__ */ jsx45(Button_default, { variant: "secondary", size: "sm", onClick: resetOverrides, leftIcon: /* @__PURE__ */ jsx45(RotateCcw, { className: "h-4 w-4" }), children: "Reset" })
    ] }) }),
      ...
      /* @__PURE__ */ jsxs32("div", { className: "grid gap-xl md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs32("div", { className: "space-y-lg", children: [
          ...
          /* @__PURE__ */ jsxs32("div", { children: [
            ...
            /* @__PURE__ */ jsx45("div", { className: "grid gap-md sm:grid-cols-2", children: editableColorTokens.map((token) => /* @__PURE__ */ jsxs32("label", { className: "flex items-center gap-md rounded-xl border border-border bg-surface p-md", children: [
              /* @__PURE__ */ jsx45(
                "input",
                {
                  type: "color",
        ...
        /* @__PURE__ */ jsxs32("div", { className: "space-y-md rounded-2xl border border-border bg-background p-lg", children: [
          ...
          /* @__PURE__ */ jsx45(Input_default, { label: "Spacing Scale", value: `${theme.tokens.spacing.sm} / ${theme.tokens.spacing.lg} / ${theme.tokens.spacing["2xl"]}`, readOnly: true }),
          /* @__PURE__ */ jsx45(Input_default, { label: "Border Radius", value: `${theme.tokens.radius.sm} / ${theme.tokens.radius.md} / ${theme.tokens.radius.lg}`, readOnly: true })
        ] })
      ] }),
